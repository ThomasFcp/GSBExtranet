				...
				<div class="box">
						...
						<legend>je suis médecin, je souhaite créer un compte</legend>
							<form method="post" action="index.php?uc=creation&action=valideCreation">
								...
								<br>                                            <br>
                                                                <input name="consentement" class="form-control" type="checkbox"> <br>
                                                                <p> J'atteste avoir lu et accepte notre <a href="vues/v_politiqueprotectiondonnees.html"> politique de protection des données</a></p>
